...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Create New Dental Procedure</h1>
                <p class="text-gray-600 mt-1">
                    Add a new procedure to the catalog with appropriate details and pricing
                </p>
            </div>
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="standard_duration" value="{{ old('standard_duration', 30) }}"
                                    class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="standard_cost" value="{{ old('standard_cost') }}"
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4"
                                ...
                                placeholder="Describe the procedure, steps involved, materials used, etc.">{{ old('description') }}</textarea>
