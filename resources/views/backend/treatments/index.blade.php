            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-900 text-white">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-sm font-medium">Sessions</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($treatments as $treatment)
                        <tr class="hover:bg-gray-50 even:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="text-gray-800">{{ Str::limit($treatment->diagnosis, 50) }}</div>
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="font-medium">{{ $treatment->session_progress_text }}</div>
                                <div class="mt-1">{!! $treatment->progress_bar !!}</div>
                            </td>

                            <td class="px-4 py-3 text-sm">
                                <div class="font-medium">{{ $treatment->formatted_estimated_cost }}</div>
