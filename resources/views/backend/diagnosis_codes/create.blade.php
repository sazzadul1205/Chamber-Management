...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Add New Diagnosis Code (ICD-10)</h1>
                <p class="text-gray-600 mt-1">
                    Add a new diagnosis code with appropriate details and categorization
                </p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow">
            <form action="{{ route('backend.diagnosis-codes.store') }}" method="POST" class="space-y-6" id="diagnosisForm">
                @csrf
                    ...
                    <div class="border-t pt-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4"
                                ...
                                placeholder="Enter full diagnosis description, symptoms, or clinical notes">{{ old('description') }}</textarea>
                ...
                <div class="px-6 pb-4 bg-gray-50 border-t border-gray-200">
                    <x-back-submit-buttons back-url="{{ route('backend.diagnosis-codes.index') }}"
                        submit-text="Save Diagnosis Code" />
                </div>
            </form>
        </div>
    </div>
