<svg class="{{ $class ?? 'w-5 h-5' }}" version="1.1" xmlns="http://www.w3.org/2000/svg"
    xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" fill="currentColor" {{ $attributes ?? '' }}>
    <g>
