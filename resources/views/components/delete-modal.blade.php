<div id="{{ $id }}" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-20">
            ...
            btn.addEventListener('click', () => {
                ...
                if (messageEl && btn.dataset.name) {
                    messageEl.textContent =
                        `Are you sure you want to delete "${btn.dataset.name}" Data?`;
                }
