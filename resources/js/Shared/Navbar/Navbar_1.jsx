...
const Navbar = ({ navItems = [] }) => {
    ...
    return (
        <>
            <nav className="bg-white shadow-md sticky top-0 text-black z-50">
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-between h-16">
                        ...
                        <ul className="hidden lg:flex items-center space-x-6 font-medium text-gray-700">
                            {/* Show first 5 items directly in menu */}
                            ...
                            {finalNavItems.length > 5 && (
                                <li className="relative group">
                                    <button className="flex items-center px-2 py-1 text-gray-700 hover:text-blue-600 transition-colors whitespace-nowrap">
                                        More
                                        <svg
                                    ...
                                    {/* Dropdown Menu */}
                                    <div className="absolute left-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 border border-gray-100">
                                        {finalNavItems.slice(5).map((item) =>
                                            sectionExists(item.id) ? (
                                                <button
                                                    key={item.id}
                                                    onClick={() =>
