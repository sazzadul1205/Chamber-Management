                        ...
                        <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <dd class="mt-1 text-lg font-semibold text-gray-900">
                                    {{ $treatmentProcedure->procedure_code }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Procedure Name</dt>
                                <dd class="mt-1 text-lg font-semibold text-gray-900">
                                    {{ $treatmentProcedure->procedure_name }}</dd>
                            </div>
                            ...
                            <div>
                                ...
                                <dd class="mt-1">
                                    ...
                                    @endphp
                                    <span
                                        class="px-3 py-1 text-sm font-semibold rounded-full {{ $statusColors[$treatmentProcedure->status] }}">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="mt-1 text-lg font-semibold text-gray-900">
                                    {{ $treatmentProcedure->treatment->patient->full_name ??
        $treatmentProcedure->treatment->patient->name ??
        $treatmentProcedure->treatment->patient->first_name . ' ' . $treatmentProcedure->treatment->patient->last_name ??
        'N/A' }}
                                </p>
                            </div>
        ...
        ($treatmentProcedure->treatment->status == 'completed' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800') }}">
                ...
                <div class="bg-white rounded-lg shadow">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <form action="{{ route('backend.treatment-procedures.destroy', $treatmentProcedure) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
